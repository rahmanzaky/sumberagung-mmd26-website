import { getPengajuanSurat, updateStatusAction } from '@/repository/pengajuan-surat/action';
import PengajuanSuratTable from '../component/PengajuanSuratTable';

export default async function PengajuanSuratContainer() {
