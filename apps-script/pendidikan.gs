// Tingkat Pendidikan (daftar berurut) — Google Apps Script Web App
...
const SHEET_NAME = 'Pendidikan';
const HEADERS = ['id', 'jenjang', 'persentase', 'urutan'];
const PREFIX_ID = 'tp-';
...
function normalizeCell_(header, value) {
  if (header === 'urutan' || header === 'persentase') {
