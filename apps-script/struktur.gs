// Struktur Organisasi (daftar berurut) — Google Apps Script Web App
...
const SHEET_NAME = 'Struktur';
const HEADERS = ['id', 'namaJabatan', 'namaPejabat', 'urlFoto', 'level', 'urutan'];
const PREFIX_ID = 'jb-';
