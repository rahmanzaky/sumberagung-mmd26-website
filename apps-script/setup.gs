...
// Fungsi ini membuat tab "BukuTamu" & "PengajuanSurat" beserta baris header
// yang formatnya HARUS cocok dengan docs/api-contract.md.
//
// Cara pakai:
//   1. Buka Spreadsheet Google → Extensions > Apps Script
//   2. Paste file ini + bukuTamu.gs + pengajuanSurat.gs
